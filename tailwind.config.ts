    ...
    extend: {
      ...
      keyframes: {
        ...
        "flame-flicker": {
          ...
          "75%": { transform: "scale(1.03) rotate(2deg)", opacity: "1" },
        },
        "petal-fall": {
        ...
        "pulse-glow": {
          "0%, 100%": { boxShadow: "0 0 0 0 hsl(var(--saffron) / 0.5)" },
          "50%": { boxShadow: "0 0 0 16px hsl(var(--saffron) / 0)" },
        },
      ...
      animation: {
        ...
        "petal": "petal-fall 12s linear infinite",
